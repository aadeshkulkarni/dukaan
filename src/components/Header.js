...
const Header = () => {
  return (
    <header className="w-full px-8 py-3 gap-4 grid grid-rows-12 md:grid-cols-12 items-center border-b border-b-gray-200 bg-white">
      ...
      <div className="row-span-4 md:col-span-4 relative">
      ...
      <div className="row-span-4 md:col-span-4 flex items-center justify-center md:justify-end">
